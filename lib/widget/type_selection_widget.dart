            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color:
                          appMainColor.withOpacity(isTrue == true ? 1 : 0.5)),
                ),
                child: Container(
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    color: appMainColor.withOpacity(isTrue == true ? 1 : 0.5),
                  ),
                ),
              ),
              ...
              Container(
                ...
                width: 50,
                decoration:
                    BoxDecoration(shape: BoxShape.circle, color: appMainColor),
                child: Image.asset(
                  imageIcon,
                  // height: 90,
                  // width: 90,
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Container( 
           width: Get.width * 0.8, 
            child: Text(data!, style: AppTextStyle.normalBold16,))
        ],
      ),
    );
  }
