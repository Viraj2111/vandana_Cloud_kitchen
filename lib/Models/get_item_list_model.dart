...
GetItemListModel getItemListModelFromJson(String str) => GetItemListModel.fromJson(json.decode(str));

String getItemListModelToJson(GetItemListModel data) => json.encode(data.toJson());
...
class GetItemListModel {
  ...
  factory GetItemListModel.fromJson(Map<String, dynamic> json) => GetItemListModel(
